...
;(function (window, factory) {
  ...
  Unipointer.prototype.onMSPointerDown = Unipointer.prototype.onpointerdown = function (
    event,
  ) {
    this._pointerDown(event, event)
  }
  ...
  Unipointer.prototype.onMSPointerMove = Unipointer.prototype.onpointermove = function (
    event,
  ) {
  ...
  Unipointer.prototype.onMSPointerUp = Unipointer.prototype.onpointerup = function (
    event,
  ) {
    if (event.pointerId == this.pointerIdentifier) {
      this._pointerUp(event, event)
  ...
  Unipointer.prototype.onMSPointerCancel = Unipointer.prototype.onpointercancel = function (
    event,
  ) {
    if (event.pointerId == this.pointerIdentifier) {
...
;(function (window, factory) {
  ...
  proto.dragEndRestingSelect = function () {
    ...
    if (this.options.contain && !this.options.wrapAround) {
      index =
        Math.abs(index - this.selectedIndex) <= 1 ? this.selectedIndex : index
    }
    return index
  }
